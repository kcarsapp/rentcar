...
class ProfileMapper extends ClassMapperBase<Profile> {
  ...
  static const Field<Profile, int> _f$serial = Field(
    'serial',
    _$serial,
    opt: true,
  );
  ...
  static const Field<Profile, DateTime> _f$joinedAt = Field(
    'joinedAt',
    _$joinedAt,
    opt: true,
  );
  static DateTime? _$emailVerifiedAt(Profile v) => v.emailVerifiedAt;
  static const Field<Profile, DateTime> _f$emailVerifiedAt = Field(
    'emailVerifiedAt',
    _$emailVerifiedAt,
    opt: true,
  );
  static DateTime? _$phoneVerifiedAt(Profile v) => v.phoneVerifiedAt;
  static const Field<Profile, DateTime> _f$phoneVerifiedAt = Field(
    'phoneVerifiedAt',
    _$phoneVerifiedAt,
    opt: true,
  );
  ...
  static const Field<Profile, String> _f$image = Field(
    'image',
    _$image,
    opt: true,
  );
  ...
  static const Field<Profile, String> _f$countryCode = Field(
    'countryCode',
    _$countryCode,
  );
  static List<Permissions> _$permissions(Profile v) => v.permissions;
  static const Field<Profile, List<Permissions>> _f$permissions = Field(
    'permissions',
    _$permissions,
  );
  static Company? _$company(Profile v) => v.company;
  static const Field<Profile, Company> _f$company = Field(
    'company',
    _$company,
    opt: true,
  );
  static String? _$accessToken(Profile v) => v.accessToken;
  static const Field<Profile, String> _f$accessToken = Field(
    'accessToken',
    _$accessToken,
    opt: true,
  );
  static String? _$refreshToken(Profile v) => v.refreshToken;
  static const Field<Profile, String> _f$refreshToken = Field(
    'refreshToken',
    _$refreshToken,
    opt: true,
  );
  static String? _$kycStatus(Profile v) => v.kycStatus;
  static const Field<Profile, String> _f$kycStatus = Field(
    'kycStatus',
    _$kycStatus,
    opt: true,
  );
  static String? _$kycDocumentType(Profile v) => v.kycDocumentType;
  static const Field<Profile, String> _f$kycDocumentType = Field(
    'kycDocumentType',
    _$kycDocumentType,
    opt: true,
  );
  static bool? _$isPersonal(Profile v) => v.isPersonal;
  static const Field<Profile, bool> _f$isPersonal = Field(
    'isPersonal',
    _$isPersonal,
    opt: true,
  );
  static DateTime? _$kycSubmittedAt(Profile v) => v.kycSubmittedAt;
  static const Field<Profile, DateTime> _f$kycSubmittedAt = Field(
    'kycSubmittedAt',
    _$kycSubmittedAt,
    opt: true,
  );
  static DateTime? _$kycReviewedAt(Profile v) => v.kycReviewedAt;
  static const Field<Profile, DateTime> _f$kycReviewedAt = Field(
    'kycReviewedAt',
    _$kycReviewedAt,
    opt: true,
  );
  static String? _$kycRejectionReason(Profile v) => v.kycRejectionReason;
  static const Field<Profile, String> _f$kycRejectionReason = Field(
    'kycRejectionReason',
    _$kycRejectionReason,
    opt: true,
  );
  ...
  final MappableFields<Profile> fields = const {
    ...
    #kycDocumentType: _f$kycDocumentType,
    #isPersonal: _f$isPersonal,
    #kycSubmittedAt: _f$kycSubmittedAt,
    #kycReviewedAt: _f$kycReviewedAt,
    #kycRejectionReason: _f$kycRejectionReason,
  };
  ...
  static Profile _instantiate(DecodingData data) {
    return Profile(
      ...
      kycStatus: data.dec(_f$kycStatus),
      kycDocumentType: data.dec(_f$kycDocumentType),
      isPersonal: data.dec(_f$isPersonal),
      kycSubmittedAt: data.dec(_f$kycSubmittedAt),
      kycReviewedAt: data.dec(_f$kycReviewedAt),
      kycRejectionReason: data.dec(_f$kycRejectionReason),
    );
  }
...
class _ProfileCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    Object? kycStatus = $none,
    Object? kycDocumentType = $none,
    Object? isPersonal = $none,
    Object? kycSubmittedAt = $none,
    Object? kycReviewedAt = $none,
    Object? kycRejectionReason = $none,
  }) => $apply(
    FieldCopyWithData({
      if (id != $none) #id: id,
      ...
      if (kycStatus != $none) #kycStatus: kycStatus,
      if (kycDocumentType != $none) #kycDocumentType: kycDocumentType,
      if (isPersonal != $none) #isPersonal: isPersonal,
      if (kycSubmittedAt != $none) #kycSubmittedAt: kycSubmittedAt,
      if (kycReviewedAt != $none) #kycReviewedAt: kycReviewedAt,
      if (kycRejectionReason != $none) #kycRejectionReason: kycRejectionReason,
    }),
  );
  @override
  Profile $make(CopyWithData data) => Profile(
    ...
    kycStatus: data.get(#kycStatus, or: $value.kycStatus),
    kycDocumentType: data.get(#kycDocumentType, or: $value.kycDocumentType),
    isPersonal: data.get(#isPersonal, or: $value.isPersonal),
    kycSubmittedAt: data.get(#kycSubmittedAt, or: $value.kycSubmittedAt),
    kycReviewedAt: data.get(#kycReviewedAt, or: $value.kycReviewedAt),
    kycRejectionReason: data.get(
      #kycRejectionReason,
      or: $value.kycRejectionReason,
    ),
  );
