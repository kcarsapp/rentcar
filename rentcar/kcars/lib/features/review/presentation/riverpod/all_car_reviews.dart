...
part 'all_car_reviews.g.dart';

@riverpod
class AllCarReviews extends _$AllCarReviews {
  ...
  Future<void> loadInitial() async {
    final result = await _reviewRepo.allCarReviews(param);
  ...
  Future<void> loadMore() async {
    ...
    final result = await _reviewRepo.allCarReviews(
