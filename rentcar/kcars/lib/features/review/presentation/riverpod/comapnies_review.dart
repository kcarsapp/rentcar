...
part 'comapnies_review.g.dart';

@riverpod
class CompaniesReviews extends _$CompaniesReviews {
  ...
  Future<void> loadInitial() async {
    ...
    final result = await _reviewRepo.companiesReviews();
  ...
  Future<void> loadMore() async {
    ...
    final result = await _reviewRepo.companiesReviews(cursor);
