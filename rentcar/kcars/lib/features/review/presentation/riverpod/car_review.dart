...
@riverpod
class CarReviews extends _$CarReviews {
  ...
  Future<void> loadInitial() async {
    final result = await _reviewRepo.carReviews(
      param.copyWith(cursor: param.cursor),
    );
    result.fold(
  ...
  Future<void> loadMore() async {
    ...
    final result = await _reviewRepo.carReviews(cursor);
